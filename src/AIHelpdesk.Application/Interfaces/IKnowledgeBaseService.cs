...
public interface IKnowledgeBaseService
{
    ...
    Task<KnowledgeDocumentResponse> UploadDocumentAsync(Guid userId, string title, string fileName, Stream fileStream, string contentType, Guid? departmentId = null);
    Task DeleteDocumentAsync(Guid id);
    Task<KnowledgeDocumentResponse> IndexDocumentAsync(Guid id);
    Task<List<KnowledgeSearchResult>> SearchAsync(string query, int topK, Guid? requesterDepartmentId = null);
}
